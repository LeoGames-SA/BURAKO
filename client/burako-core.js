/* ============================================================
   ...
   OJO: este archivo es una COPIA de server/burako-core.js, que
   existe acá solo para que el modo offline (abierto como archivo
   local, sin servidor HTTP) también pueda cargarlo con un
   <script src="burako-core.js"> relativo. Cuando el juego corre
   con servidor (node server.js), el navegador en realidad recibe
   el burako-core.js de server/ (el servidor lo prioriza al
   resolver archivos estáticos) — este archivo de client/ es
   el que se usa únicamente sin servidor. Si tocás la lógica de
   la IA o de meldInfo, actualizá los DOS archivos.
   ============================================================ */
